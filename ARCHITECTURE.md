...
| Тема | Theme ("Светлая") |
| История | List<SessionHistoryEntry>, MaxHistoryCount (20), DeleteFilesOnClear (false) |
...
- [x] Installer (Inno Setup, installer/ClipNotes.iss)
- [x] GitHub Actions (build.yml), Issue Templates
